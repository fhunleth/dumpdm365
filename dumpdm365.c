...
static struct Dm365Register registers[] = 
  {
    ...
    {0x1c40000, "System Module", "PINMUX0", "Pin Mux 0 Register"},
    {0x1c40004, "System Module", "PINMUX1", "Pin Mux 1 Register"},
    {0x1c40008, "System Module", "PINMUX2", "Pin Mux 2 Register"},
    {0x1c4000c, "System Module", "PINMUX3", "Pin Mux 3 Register"},
    {0x1c40010, "System Module", "PINMUX4", "Pin Mux 4 Register"},
    {0x1c40014, "System Module", "BOOTCFG", "Boot Configuration Register"},
    {0x1c40018, "System Module", "ARM_INTMUX", "Multiplexing Control for ARM Interrupts Register"},
    {0x1c4001c, "System Module", "EDMA_EVTMUX", "Multiplexing Control for EDMA Events Register"},
    {0x1c40024, "System Module", "HPI_CTL", "HPI Control Register"},
    {0x1c40028, "System Module", "DEVICE_ID", "Device ID Register"},
    {0x1c4002c, "System Module", "VDAC_CONFIG", "Video DAC Configuration Register"},
    {0x1c40030, "System Module", "TIMER64_CTL", "Timer Input Control Register"},
    {0x1c40034, "System Module", "USB_PHY_CTRL", "USB PHY Control Register"},
    {0x1c40038, "System Module", "MISC", "Miscellaneous Control Register"},
    {0x1c4003c, "System Module", "MSTPRI0", "Master Priorities 0 Register"},
    {0x1c40040, "System Module", "MSTPRI1", "Master Priorities 1 Register"},
    {0x1c40044, "System Module", "VPSS_CLK_CTRL", "VPSS Clock Mux Control Register"},
    {0x1c40048, "System Module", "PERI_CLKCTL", "Peripheral Clock Control Register"},
    {0x1c4004c, "System Module", "DEEPSLEEP", "DEEPSLEEP Control Register"},
    {0x1c40054, "System Module", "DEBOUNCE0", "De-bounce GIO0 input Register"},
    {0x1c40058, "System Module", "DEBOUNCE1", "De-bounce GIO1 input Register"},
    {0x1c4005c, "System Module", "DEBOUNCE2", "De-bounce GIO2 input Register"},
    {0x1c40060, "System Module", "DEBOUNCE3", "De-bounce GIO3 input Register"},
    {0x1c40064, "System Module", "DEBOUNCE4", "De-bounce GIO4 input Register"},
    {0x1c40068, "System Module", "DEBOUNCE5", "De-bounce GIO5 input Register"},
    {0x1c4006c, "System Module", "DEBOUNCE6", "De-bounce GIO6 input Register"},
    {0x1c40070, "System Module", "DEBOUNCE7", "De-bounce GIO7 input Register"},
    {0x1c40074, "System Module", "VTPIOCR", "VTP IO Control Register"},
    {0x1c40078, "System Module", "PUPDCTL0", "IO cell pull up/down control 0 Register"},
    {0x1c4007c, "System Module", "PUPDCTL1", "IO cell pull up/down control 1 Register"},
    {0x1c40080, "System Module", "HDVICPBT", "HDVICP boot Register"},
    {0x1c40084, "System Module", "PLLC1_CONFIG", "PLLC1 configuration Register"},
    {0x1c40088, "System Module", "PLLC2_CONFIG", "PLLC2 configuration Register"},
